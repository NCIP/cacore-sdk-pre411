...
(
  PHONE_CALL_ID  NUMBER(8)                      NOT NULL
)
LOGGING 
NOCOMPRESS 
NOCACHE
...
CREATE UNIQUE INDEX UQ_FLIGHT_PASSANGER_FLIGHT_ID ON FLIGHT_PASSANGER
(FLIGHT_ID)
LOGGING
NOPARALLEL;
...
CREATE UNIQUE INDEX PK_LOCAL_PHONE_CALL ON LOCAL_PHONE_CALL
(PHONE_CALL_ID)
LOGGING
NOPARALLEL;


CREATE UNIQUE INDEX PK_LONG_DISTANCE_PHONE_CALL ON LONG_DISTANCE_PHONE_CALL
(PHONE_CALL_ID)
LOGGING
NOPARALLEL;
...
CREATE UNIQUE INDEX PK_PHONE_CALL ON PHONE_CALL
(ID)
LOGGING
NOPARALLEL;
...
ALTER TABLE LOCAL_PHONE_CALL ADD (
  CONSTRAINT PK_LOCAL_PHONE_CALL
 PRIMARY KEY
 (PHONE_CALL_ID));

ALTER TABLE LONG_DISTANCE_PHONE_CALL ADD (
  CONSTRAINT PK_LONG_DISTANCE_PHONE_CALL
 PRIMARY KEY
 (PHONE_CALL_ID));
...
ALTER TABLE PHONE_CALL ADD (
  CONSTRAINT PK_PHONE_CALL
 PRIMARY KEY
 (ID));
...
ALTER TABLE LOCAL_PHONE_CALL ADD (
  CONSTRAINT FK_LOCAL_PHONE_CALL_PHONE_CALL 
 FOREIGN KEY (PHONE_CALL_ID) 
 REFERENCES PHONE_CALL (ID));

ALTER TABLE LONG_DISTANCE_PHONE_CALL ADD (
  CONSTRAINT FK_LONG_DISTANCE_PH_PHONE_CALL 
 FOREIGN KEY (PHONE_CALL_ID) 
 REFERENCES PHONE_CALL (ID));
