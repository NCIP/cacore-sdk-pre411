...
import gov.nih.nci.cacoresdk.installer.common.FileFilters;
import gov.nih.nci.cacoresdk.installer.common.LookAndFeel;
import gov.nih.nci.cacoresdk.installer.common.ResourceManager;
...
public class GenerationViewer extends GenerationViewerBaseComponent {
	...
	public static final String INSTALLER_PROPERTIES_FILE = "installer.properties";
	public static final String DEFAULT_INSTALLER_PROPS_PATH = "conf/deploy.properties.template";
	
    public static final String SCHEMA_DIR = "schema";

    public static final String SDK_INSTALL_DIR = "SDK installation directory";
    public static final String PROJECT_DIR = "Project generation directory";
    ...
    public static final String MODEL_FILE_PATH = "Model file";
    public static final String LOGICAL_MODEL_PACKAGE_NAME = "Logical Model package name";
    public static final String DATA_MODEL_PACKAGE_NAME = "Data Model package name";
    public static final String INCLUDE_PACKAGE_REGEX = "Include package Regular Expression";
    ...
    public static final String IDENTITY_GENERATOR_TAG = "Identity Generator Tag";
    public static final String CADSR_CONNECTION_URL = "caDSR Connection URL";
    
    public static final String CLM_PROJECT_NAME = "CLM Project Name";
    public static final String CLM_DB_CONNECTION_URL = "CLM DB Connection URL";
    public static final String CLM_DB_USERNAME = "CLM DB Username";
    public static final String CLM_DB_PASSWORD = "CLM DB Password";
    public static final String CLM_DB_DRIVER = "CLM DB Driver";
    
    public static final String CSM_PROJECT_NAME = "CSM Project Name";
    ...
    public static final String CAGRID_LOGIN_MODULE_NAME = "caGrid Login Module Name";
    public static final String CAGRID_AUTHENTICATION_SERVICE_URL = "caGrid Authentication Service URL";
    public static final String CAGRID_DORIAN_SERVICE_URL = "caGrid Dorian Service URL";
    public static final String SDK_GRID_LOGIN_SERVICE_NAME = "SDK Grid Login Service Name";
    public static final String SDK_GRID_LOGIN_SERVICE_URL = "SDK Grid Login Service URL";
    ...
    public GenerationViewer() {
        ...
        //to load deploy settings from either installer template or existing project 
        //properties file
        String projectDirPath=null;
//		try {
//			projectDirPath = JOptionPane
//			.showInputDialog(
//					this,
//					"Please enter the directory where the project should be generated: ",
//					"",//ResourceManager.promptDir(""),
...
//		
        ...
        if (projectDir.exists()){
        	String installerPropsPath = projectDirPath+File.separator+INSTALLER_PROPERTIES_FILE;
        	
        	File installerProps = new File(installerPropsPath);
        	if (installerProps.exists())
        		deployPropsMgr = new DeployPropertiesManager(installerPropsPath);
        } 
        
        //if project properties file does not exist, use default installer template properties
        if (deployPropsMgr==null){
        	deployPropsMgr = new DeployPropertiesManager(DEFAULT_INSTALLER_PROPS_PATH);
        }
    ...
    private void initValidation() {
        ...
        //Writable API
        ValidationComponentUtils.setMessageKey(getDatabaseTypeField(), DATABASE_TYPE);
        ValidationComponentUtils.setMandatory(getDatabaseTypeField(), true);
    ...
    private void validateInput() {
    	...
    	if (getEnableWritableApiExtensionCheckBox().isSelected()){
    		...
    		if (!ValidationUtils.isNotBlank(this.getDatabaseTypeField().getText())) {
    			result.add(new SimpleValidationMessage(DATABASE_TYPE + " must not be blank.", Severity.ERROR, DATABASE_TYPE));
    		}
    ...
    private void updateCaGridEnvironmentFields(){
	    ...
	    if (!caGridEnv.equals("")){
	    	caGridAuthSvcUrlField.setText(caGridEnv);
	    	caGridDorianSvcUrlField.setText(caGridEnv);
	    }
    ...
    private JButton getGenerateButton() {
        if (generateButton == null) {
            ...
            generateButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    generateApplication(getSdkInstallDirField().getText(),getProjectDirField().getText(),getInstallerPropsMap()); 
                }
            });
        }
...
//  TODO :: Is there a grouping? do caGrid Login fields need to be toggled?    
...
//    TODO :: Is there a grouping? do CSM Login fields need to be toggled?
...
//		}
    ...
    protected void toggleModelFileType() {
    	if (getModelFileField().getText().endsWith(".xmi")){
    		getModelFileTypeField().setSelectedItem("EA");
    	} else if (getModelFileField().getText().endsWith(".uml")){
    		getModelFileTypeField().setSelectedItem("ARGO");
    	} else {
    ...
    private JTextField getWebServiceNameField() {
        if (webserviceNameField == null) {
            ...
            webserviceNameField.setText(deployPropsMgr.getDeployPropertyValue("PROJECT_NAME")+"Service");
    ...
    private JComboBox getModelFileTypeField() {
        if (modelFileTypeComboBox == null) {
            ...
            String modelFileType = deployPropsMgr.getDeployPropertyValue("MODEL_FILE_TYPE");
    ...
    private JTextField getDatabaseTypeField() {
        if (databaseTypeField == null) {
        	...
        	databaseTypeField.setText(deployPropsMgr.getDeployPropertyValue("DATABASE_TYPE"));
    ...
    private JTextField getClmProjectName() {
        if (clmProjectName == null) {
        	...
        	clmProjectName.setText(deployPropsMgr.getDeployPropertyValue("PROJECT_NAME"));
    ...
    private JTextField getClmDbConnectionUrlField() {
        if (clmDbConnectionUrlField == null) {
        	...
        	clmDbConnectionUrlField.setText(deployPropsMgr.getDeployPropertyValue("DB_CONNECTION_URL"));
    ...
    private JTextField getClmDbUsernameField() {
        if (clmDbUsernameField == null) {
        	...
        	clmDbUsernameField.setText(deployPropsMgr.getDeployPropertyValue("DB_USERNAME"));
    ...
    private JTextField getClmDbPasswordField() {
        if (clmDbPasswordField == null) {
        	...
        	clmDbPasswordField.setText(deployPropsMgr.getDeployPropertyValue("DB_PASSWORD"));
    ...
    private JTextField getClmDbDriverField() {
        if (clmDbDriverField == null) {
        	...
        	clmDbDriverField.setText(deployPropsMgr.getDeployPropertyValue("DB_DRIVER"));
    ...
    private JTextField getCsmProjectNameField() {
        if (csmProjectNameField == null) {
        	...
        	csmProjectNameField.setText(deployPropsMgr.getDeployPropertyValue("PROJECT_NAME"));
    ...
    private JCheckBox getCsmUseJndiBasedConnectionCheckBox() {
        if (csmUseJndiBasedConnectionCheckBox == null) {
        	...
        	csmUseJndiBasedConnectionCheckBox.setSelected(Boolean.parseBoolean(deployPropsMgr.getDeployPropertyValue("USE_JNDI_BASED_CONNECTION")));
    ...
    private JTextField getCsmDbJndiUrlField() {
        if (csmDbJndiUrlField == null) {
        	...
        	csmDbJndiUrlField.setText(deployPropsMgr.getDeployPropertyValue("DB_JNDI_URL"));
    ...
    private JTextField getCsmDbConnectionUrlField() {
        if (csmDbConnectionUrlField == null) {
        	...
        	csmDbConnectionUrlField.setText(deployPropsMgr.getDeployPropertyValue("DB_CONNECTION_URL"));
    ...
    private JTextField getCsmDbUsernameField() {
        if (csmDbUsernameField == null) {
        	...
        	csmDbUsernameField.setText(deployPropsMgr.getDeployPropertyValue("DB_USERNAME"));
    ...
    private JTextField getCsmDbPasswordField() {
        if (csmDbPasswordField == null) {
        	...
        	csmDbPasswordField.setText(deployPropsMgr.getDeployPropertyValue("DB_PASSWORD"));
    ...
    private JTextField getCsmDbDriverField() {
        if (csmDbDriverField == null) {
        	...
        	csmDbDriverField.setText(deployPropsMgr.getDeployPropertyValue("DB_DRIVER"));
    ...
    private JTextField getCsmDbDialectField() {
        if (csmDbDialectField == null) {
        	...
        	csmDbDialectField.setText(deployPropsMgr.getDeployPropertyValue("DB_DIALECT"));
    ...
    private JTextField getSdkGridLoginSvcUrlField() {
    	if (sdkGridLoginSvcUrlField == null) {
    		...
    		String sdkGridLoginServiceURL = deployPropsMgr.getDeployPropertyValue("SDK_GRID_LOGIN_SERVICE_URL");
    		String sdkGridLoginServiceName = deployPropsMgr.getDeployPropertyValue("SDK_GRID_LOGIN_SERVICE_NAME");
    		if (sdkGridLoginServiceURL.indexOf('$')>0)//from deploy.properties.template
    ...
    private JCheckBox getEnableCsmLoginModuleCheckBox() {
        if (enableCsmLoginModuleCheckBox == null) {
        	...
        	enableCsmLoginModuleCheckBox.setSelected(Boolean.parseBoolean(deployPropsMgr.getDeployPropertyValue("ENABLE_CSM_LOGIN_MODULE")));
    ...
    private JComboBox getCaGridEnvironmentComboBox() {
    	if (caGridEnvironmentComboBox == null) {
    		...
    		caGridEnvironmentComboBox.addItem("");
    		caGridEnvironmentComboBox.addItem("https://dorian.training.cagrid.org:8443/wsrf/services/cagrid/Dorian");  // TODO :: externalize???
    ...
    private JComboBox getServerTypeComboBox() {
    	if (serverTypeComboBox == null) {
    		...
    		String serverType = deployPropsMgr.getDeployPropertyValue("SERVER_TYPE");
    ...
    private JTextField getServerUrlField() {
    	if (serverUrlField == null) {
    		...
    		String projectName = deployPropsMgr.getDeployPropertyValue("PROJECT_NAME");
    		String serverUrl = deployPropsMgr.getDeployPropertyValue("SERVER_URL");
...
//			gridBagConstraints20.weighty = 1.0D;
	...
	/**
	 * This method initializes the common logging module settings panel	
	 * 	
	 * @return javax.swing.JPanel	
	 */
	...
	private JPanel getDbConnectionSettingsPanel() {
		if (dbConnectionSettingsPanel == null) {
		    ...
		    dbConnectionSettingsPanel.add(getDbConnectionJndiSettingsSubPanel(), gridBagConstraints20);
		    dbConnectionSettingsPanel.add(getDbConnectionSettingsSubPanel(), gridBagConstraints30);
	...
	private JPanel getDbConnectionSettingsSubPanel() {
		if (dbConnectionSettingsSubPanel == null) {
		    ...
		    dbConnectionSettingsSubPanel.add(dbDialectLabel, gridBagConstraints50);
		    dbConnectionSettingsSubPanel.add(getDbDialectField(), gridBagConstraints51);   
	...
	private JPanel getCsmDbConnectionSettingsPanel() {
		if (csmDbConnectionSettingsPanel == null) {
		    ...
		    csmDbConnectionSettingsPanel.add(getCsmDbConnectionJndiSettingsSubPanel(), gridBagConstraints20);
		    csmDbConnectionSettingsPanel.add(getCsmDbConnectionSettingsSubPanel(), gridBagConstraints30);
	...
	private JPanel getCsmDbConnectionJndiSettingsSubPanel() {
		if (csmDbConnectionJndiSettingsSubPanel == null) {
		    ...
		    csmDbJndiUrlLabel.setText("Database JNDI URL:         ");
	...
	private JPanel getCsmDbConnectionSettingsSubPanel() {
		if (csmDbConnectionSettingsSubPanel == null) {
		    ...
		    csmDbConnectionSettingsSubPanel.add(csmDbDialectLabel, gridBagConstraints50);
		    csmDbConnectionSettingsSubPanel.add(getCsmDbDialectField(), gridBagConstraints51);   
	...
	private JPanel getCaGridAuthSettingsPanel() {
		if (caGridAuthSettingsPanel == null) {
		    ...
		    caGridAuthSettingsPanel.add(enableCsmLoginModuleLabel, gridBagConstraints20);
		    caGridAuthSettingsPanel.add(getEnableCsmLoginModuleCheckBox(), gridBagConstraints21);
		    caGridAuthSettingsPanel.add(caGridEnvironmentLabel, gridBagConstraints30);
		    caGridAuthSettingsPanel.add(getCaGridEnvironmentComboBox(), gridBagConstraints31);
		    caGridAuthSettingsPanel.add(caGridAuthSvcUrlLabel, gridBagConstraints40);
		    caGridAuthSettingsPanel.add(getCaGridAuthSvcUrlField(), gridBagConstraints41);
		    caGridAuthSettingsPanel.add(caGridDorianSvcUrlLabel, gridBagConstraints50);
		    caGridAuthSettingsPanel.add(getCaGridDorianSvcUrlField(), gridBagConstraints51);
		    caGridAuthSettingsPanel.add(sdkGridLoginSvcNameLabel, gridBagConstraints60);
		    caGridAuthSettingsPanel.add(getSdkGridLoginSvcNameField(), gridBagConstraints61);
		    caGridAuthSettingsPanel.add(sdkGridLoginSvcUrlLabel, gridBagConstraints70);
		    caGridAuthSettingsPanel.add(getSdkGridLoginSvcUrlField(), gridBagConstraints71);
		    caGridAuthSettingsPanel.add(caGridLoginModuleNameLabel, gridBagConstraints80);
		    caGridAuthSettingsPanel.add(getCaGridLoginModuleNameField(), gridBagConstraints81);
		    caGridAuthSettingsPanel.add(caGridDorianSvcUrlLabel, gridBagConstraints90);
		    caGridAuthSettingsPanel.add(getCaGridDorianSvcUrlField(), gridBagConstraints91);
	...
	private Map<String,String> getInstallerPropsMap(){
		...
		// Project properties
		installerPropsMap.put("output.dir", (getProjectDirField().getText() + File.separator + "output").replace('\\', '/'));
		installerPropsMap.put("SDK_INSTALL_DIR", getSdkInstallDirField().getText().replace('\\', '/'));
		...
		// Model properties
		installerPropsMap.put("MODEL_FILE_PATH", getModelFileField().getText().replace('\\', '/'));
