...
import gov.nih.nci.cacoresdk.installer.common.ObjectFactory;
...
public class GenerationViewer extends GenerationViewerBaseComponent {
	...
	private static final String INSTALLER_PROPERTIES_FILE = "installer.properties";
	private static final String DEFAULT_INSTALLER_PROPERTIES_FILE = "conf/deploy.properties.template";
    ...
    private void initialize() {
        ...
        if (deployPropsMgr==null){
        	deployPropsMgr = new DeployPropertiesManager(DEFAULT_INSTALLER_PROPERTIES_FILE);
        }
...
//		}
    ...
    private JComboBox getModelFileTypeField() {
        if (modelFileTypeComboBox == null) {
            ...
            modelFileTypeComboBox.setSelectedItem(modelFileType); //todo
    ...
    private JComboBox getDatabaseTypeComboBox() {
        if (databaseTypeComboBox == null) {
        	...
        	String dbType = deployPropsMgr.getDeployPropertyValue("DATABASE_TYPE");
    ...
    private JCheckBox getCsmUseJndiBasedConnectionCheckBox() {
        if (csmUseJndiBasedConnectionCheckBox == null) {
        	...
        	csmUseJndiBasedConnectionCheckBox.setToolTipText("Use a JNDI-based Connection?");
...
//			gridBagConstraints51.gridx = 1;
	...
	private JPanel getCsmDbConnectionSettingsPanel() {
		if (csmDbConnectionSettingsPanel == null) {
		    ...
		    csmDbConnectionSettingsPanel.add(getCsmDbDialectSettingsSubPanel(), gridBagConstraints40);
	...
	private Map<String,String> getInstallerPropsMap(){
		...
		installerPropsMap.put("MODEL_FILE_TYPE", modelFileTypeOptionsMap.get(getModelFileTypeField().getSelectedItem().toString()));
		...
		installerPropsMap.put("DATABASE_TYPE", databaseTypeOptionsMap.get(getDatabaseTypeComboBox().getSelectedItem().toString()));
